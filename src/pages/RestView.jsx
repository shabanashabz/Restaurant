  ...
  return (
    <>
        <Row className='mt-5 mb-5'>
            <Col md={1} ></Col>
            <Col md={3}>
                <img src={selectedRestaurant?.photograph} alt="" width={'100%'} height={'100%'} className='rounded'/>
                </Col>
                <Col md={7} className='px-5'>
                <hr />
                <h5 className='text-center'>Restuarant <span className='text-warning '>Details</span></h5>
                <hr />
                <ListGroup>
                ...
                <div>
                    {
                        ...
                        selectedRestaurant.reviews.map((item)=>(
                            <div>
                                <hr />
                                <div className='mt-2'>
                                    <h6 className='text-dark'>Name And Date: {item.name} - {item.date}</h6>
